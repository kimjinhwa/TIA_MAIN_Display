 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font C:\Users\ServerManager\Documents\SquareLine\assets\arial.ttf -o C:\Users\ServerManager\Documents\SquareLine\assets\ui_font_montserrat16.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_MONTSERRAT16
#define UI_FONT_MONTSERRAT16 1
#endif

#if UI_FONT_MONTSERRAT16
...
#if LV_VERSION_CHECK(8, 0, 0)
const lv_font_t ui_font_montserrat16 = {
#else
lv_font_t ui_font_montserrat16 = {
#endif
