 ...
 * Size: 16 px
 * Bpp: 1
 * Opts: --bpp 1 --size 16 --font C:\Users\ServerManager\Documents\SquareLine\assets\arial.ttf -o C:\Users\ServerManager\Documents\SquareLine\assets\ui_font_Arial.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/
